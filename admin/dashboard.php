            ...
            <div class="ms-auto d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg mt-3" style="width: 300px;">
                        ...
                        <li><a class="dropdown-item text-center small text-primary py-2" href="#">View all alerts</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container-fluid p-4 pt-0">
            ...
            <div class="row g-0 mb-5 mt-3 py-4 border-bottom align-items-center">
                ...
                <div class="col-md-4 text-md-end">
                    <h2 class="mb-0 fw-black text-dark text-uppercase" style="letter-spacing: 4px; font-weight: 800;"
                        id="dayDisplay">---</h2>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 hover-lift h-100">
                        <div class="card-body text-center py-3">
                            ...
                            <h6 class="text-muted text-uppercase small fw-bold mb-3" style="letter-spacing: 1px;">Exits
                                Today</h6>
                ...
                <div class="col-md-4">
                    <div class="card border-0 hover-lift h-100">
                        <div class="card-body text-center py-3">
                            ...
                            <h6 class="text-muted text-uppercase small fw-bold mb-3" style="letter-spacing: 1px;">Total
                                Homeowners</h6>
                    ...
                    <div class="card border-0 p-3">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <span class="badge bg-primary bg-opacity-10 text-primary p-2 px-3">Real-time
                                    update</span>
                            </div>
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center p-3 rounded-4 bg-light border border-white">
                                        ...
                                        <div>
                                            <h2 class="mb-0 fw-bold" id="statCurrentlyInside">
                                                <?php echo $currentlyInside; ?></h2>
                                            <p class="mb-0 text-muted fw-medium">Homeowners Inside</p>
                                        </div>
                                        <div class="ms-auto text-end">
                                            <div class="text-success small fw-bold" id="insidePercentageText">
                                                <?php echo round(($currentlyInside / $totalHomeowners) * 100); ?>%</div>
                                            <div class="progress mt-1" style="width: 60px; height: 4px;">
                                                <div class="progress-bar bg-success" id="insideProgressBar"
                                                    style="width: <?php echo ($currentlyInside / $totalHomeowners) * 100; ?>%">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center p-3 rounded-4 bg-light border border-white">
                                        ...
                                        <div>
                                            <h2 class="mb-0 fw-bold" id="statCurrentlyOutside">
                                                <?php echo $currentlyOutside; ?></h2>
                                            <p class="mb-0 text-muted fw-medium">Homeowners Outside</p>
                                        </div>
                                        <div class="ms-auto text-end">
                                            <div class="text-warning small fw-bold" id="outsidePercentageText">
                                                <?php echo round(($currentlyOutside / $totalHomeowners) * 100); ?>%</div>
                                            <div class="progress mt-1" style="width: 60px; height: 4px;">
                                                <div class="progress-bar bg-warning" id="outsideProgressBar"
                                                    style="width: <?php echo ($currentlyOutside / $totalHomeowners) * 100; ?>%">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0" id="activityLogTable">
                                    <thead class="bg-light">
                                        <tr>
                                            <th class="ps-4 py-3 text-uppercase small fw-bold text-muted border-0">
                                                Homeowner</th>
                                            <th class="py-3 text-uppercase small fw-bold text-muted border-0">ID Number
                                            </th>
                                            <th class="py-3 text-uppercase small fw-bold text-muted border-0">Movement
                                            </th>
                                            ...
                                            <th
                                                class="py-3 text-uppercase small fw-bold text-muted border-0 pe-4 text-center">
                                                Scanner</th>
                                        </tr>
                                    </thead>
                    ...
                    <form id="addHomeownerForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control rounded-3 p-2 px-3" placeholder="CSJ-2024-001"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label small fw-bold text-muted">Phone Number</label>
                                <input type="tel" class="form-control rounded-3 p-2 px-3" name="phone" placeholder="09123456789" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control rounded-3 p-2 px-3" placeholder="john@example.com"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label small fw-bold text-muted">Home Address</label>
                            <textarea class="form-control rounded-3 p-2 px-3" rows="2" placeholder="Block & Lot Details"
                                required></textarea>
                        </div>
