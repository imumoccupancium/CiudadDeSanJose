                ...
                <form id="addVisitorForm">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3 p-2 px-3" name="visitor_name"
                        ...
                        <div class="col-md-12" id="company_field_wrapper" style="display: none;">
                            ...
                            <input type="text" class="form-control rounded-3 p-2 px-3" name="company" id="modal_company"
                                placeholder="e.g. Grab, Shopee, Meralco">
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="position-relative" id="customSearchWrapper">
                                <input type="text" class="form-control rounded-3 p-2 px-3" id="residentSearchInput"
                                    placeholder="Type to search resident name..." autocomplete="off" required>
                                <i
                                    class="bi bi-search position-absolute top-50 end-0 translate-middle-y me-3 text-muted"></i>

                                <!-- Custom Dropdown List -->
                                <ul id="residentResultsList" class="list-group position-absolute w-100 mt-1 shadow-lg"
                            ...
                            <div id="selectionFeedback" class="small mt-2 text-success" style="display: none;">
                                <i class="bi bi-check2-circle"></i> Resident selected: <strong
                                    id="selectedResidentLabel"></strong>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3 p-2 px-3" name="purpose" id="modal_purpose"
                                placeholder="Hangout, Social visit, etc.">
                        </div>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="viewVisitorModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                ...
                <div class="row g-4 align-items-center">
                        ...
                        <div class="bg-light p-4 rounded-4 border border-white">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-12 mt-3" id="qr_expiry_alert">
                                    <div
                                        class="alert alert-info border-0 shadow-sm rounded-4 d-flex align-items-center mb-0 px-3 py-2">
                    ...
                    <div class="col-md-4 text-center">
                        <div class="card border-0 bg-white p-3 shadow-sm mx-auto mb-3"
                            ...
                            <div id="view_visitor_qr"
                                class="w-100 h-100 d-flex align-items-center justify-content-center bg-light rounded shadow-inner overflow-hidden">
                                <i class="bi bi-qr-code fs-1 text-muted"></i>
                            </div>
                        </div>
                        <button class="btn btn-outline-primary btn-sm rounded-pill px-4 mb-2 w-100"
                            id="downloadVisitorQR">
            ...
            <div class="modal-footer border-0 p-4 pt-0">
                <button type="button" class="btn btn-light rounded-pill px-4 w-100"
                ...
                <form id="editVisitorForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12" id="edit_company_field_wrapper" style="display: none;">
                            <label class="form-label small fw-bold text-muted">Company / Organization</label>
                            <input type="text" class="form-control rounded-3 p-2 px-3" name="company" id="edit_company"
                                placeholder="e.g. Grab, Shopee, Meralco">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label small fw-bold text-muted">Resident to Visit *</label>
                            <div class="position-relative" id="edit_customSearchWrapper">
                                <input type="text" class="form-control rounded-3 p-2 px-3" id="edit_residentSearchInput"
                                    placeholder="Type to search resident name..." autocomplete="off" required>
                                <i
                                    class="bi bi-search position-absolute top-50 end-0 translate-middle-y me-3 text-muted"></i>

                                <ul id="edit_residentResultsList"
                            ...
                            <div id="edit_selectionFeedback" class="small mt-2 text-success" style="display: none;">
                                <i class="bi bi-check2-circle"></i> Resident selected: <strong
                                    id="edit_selectedResidentLabel"></strong>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-muted">QR Pass Expiry Date</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-muted">Purpose of Visit</label>
                            <input type="text" class="form-control rounded-3 p-2 px-3" name="purpose" id="edit_purpose"
                                placeholder="Hangout, Social visit, etc.">
                        </div>
                        <div class="col-md-6">
